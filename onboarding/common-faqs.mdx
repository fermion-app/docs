...
- [Ebooks](/digital-products/introduction)
...
Yes, you can invite up to 150 participants to the stage during a live session. They can share their screen, turn on their camera, and use their microphone. Learn more about [stage](/live-classes/invite-to-stage).
</Accordion>
...
<Accordion title="Do we have a Discord server for Fermion users?">
Yes! You can connect with our community and team on our [Discord server](https://discord.com/invite/Sf45Hz38eB) for real-time support, discussions, and feature updates.
</Accordion>
...
Yes, Fermion includes community features where students can interact, ask questions, and engage with each other and instructors. Learn more about [communities](/community/what-are-communities)
</Accordion>
