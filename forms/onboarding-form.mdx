...
All onboarding form submissions are automatically stored in the **Submissions** tab inside your form. You can export them as CSV or view them directly from your dashboard.
