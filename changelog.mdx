...
<Update label="September 2025" description="Highlights">
  ## Email & Analytics
  - Added email tracking dashboard UI

  ## Livestreaming
  - New configuration to hide the seekbar in livestreams
  - Stability fixes for the seek control

  ## Checkout & Payments
  - Checkout page now uses SSG and preserves email/name/password when coupons change

  ## Video watermarking
  - Added customization options for watermarking

  ## Courses & Syllabus
  - Bulk import syllabus CSV improvements and ability to import from CSV
  - Removed deprecated resolvers
  ...
  - Enroll/Unenroll products directly from the user activity page
</Update>
