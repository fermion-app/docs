...
<Columns cols={2}>
  <Card title="Bandwidth consumed">
    Shows total **bandwidth** used by your school for all hosted content - including video, labs, and API calls. This metric is used for **bandwidth overage billing**.
  </Card>
...
<Columns cols={2}>
  ...
  <Card title="Coding & DSA labs">
    Monitor **coding lab activity** (hours spent) and **DSA lab runs** (executions). Useful for tracking student engagement and lab infrastructure usage for your entire school.
  </Card>
</Columns>

<Columns cols={2}>
  <Card title="Email analytics">
    Track all outgoing communication from your school, including:
  ...
  <Card title="DRM licenses">
    Monitor the number of **Digital Rights Management (DRM)** licenses utilized across your hosted video content.Each DRM license corresponds to a secured video playback instance.  
  </Card>
</Columns>
...
<Steps>
  ...
  <Step title="Explore metrics">
    Use the **date filter** to explore real-time data such as bandwidth, storage, traffic, email performance, and engagement.
  </Step>
</Steps>
