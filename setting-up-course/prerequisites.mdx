...
<Tip>
Courses can also be **added to Bundles** along with other products like [eBooks](/ebooks/introduction), contests, downloadable content, or [live events](/live-classes/what-are-live-classes). Bundles allow you to sell multiple products together as a single packaged offer. Learn more about [Bundles](/setting-up-course/bundle)
</Tip>
