...
![eMLzQQxRb-F4B3XOeF-Ly](https://67d6ad5ef66ee0901532fd2f.storage.fermion.app/public-uncached/object-store-public-files/uploads/22-10-2025/chrome_MOmik8kH6n.mdcixz.png)
...
-   Adding a promotional or teaser video 

### Course Enrollment Validity

You can set the enrollment validity for your course. For example, Forever means that learners will have access to the course content indefinitely after enrollment. Adjusting this setting allows you to control access duration for your students. You can also set up **custom** validity, where you will have to enter the number of hours learners should have access to the course after enrollment. Once this time expires, they will no longer be able to view the content.

### Course Created At

This field shows the date when the course was created (e.g., 30 Sep, 2025). Changing this date will reorder your course on the landing page as well as in your instructor dashboard. This can help highlight newer or updated courses to your audience.
