...
description: 'Discover how to upload an entire syllabus at once using the platform’s bulk import syllabus tools.'
icon: file-import
---
...
<Warning>
	Please note that once imported, you can only edit the items via Syllabus
	manager. Bulk importer will only allow you to import items, not edit them.
</Warning>
