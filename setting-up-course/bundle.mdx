...
You can add various product types to your bundle - including [**Courses**](/setting-up-course/prerequisites), [**eBooks**](/ebooks/introduction), [**Live Events**](/live-classes/what-are-live-classes), **Contests**, and **Downloadable Products**.
...
**Example:**  
I want to add an [**eBook**](/ebooks/introduction) to the bundle, head over to eBooks and click **Add Product to Bundle** button next to the eBook you want to add.
...
Pricing for bundles works **exactly like pricing for other product types** (such as [Courses](/setting-up-course/prerequisites) or [eBooks](/ebooks/introduction)).  
