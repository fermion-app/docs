...
-   Step 5: When you click on `Add a video` it will open a new modal for you, showing you all the videos in your [video library](/recorded-videos/video-library), if it is empty, it means that there are no videos in your video library. You can add videos in bulk by clicking on the `Upload videos` button.
...
An **assignment** is a task or activity that you can give to your students to apply the concepts they have learned in your course. Assignments help reinforce learning, encourage critical thinking, and allow you to evaluate students’ understanding of the material. They can range from coding exercises and written responses to practical projects or problem-solving tasks.

Learn more about how to create [assignments on Fermion](/setting-up-course/assignments)

## What is an eBook?

An **eBook** is a digital book or document that you can provide to your students as part of your course. eBooks are ideal for sharing detailed study materials, reference guides, notes, or comprehensive content that complements your lessons.  

You can upload PDF files to make them available for download. Students can access the eBook at any time during the course, making it a flexible resource for self-paced learning.  

For detailed instructions on adding and managing eBooks in your course, check out [eBooks on Fermion](/digital-products/landing-page).
...
Learn more about [contests on Fermion](/contests/introduction)
...
-   Step 1: Click on the `+` button to expand the course items' view.
    ![scorm-step1](https://67d6ad5ef66ee0901532fd2f.storage.fermion.app/public-uncached/object-store-public-files/uploads/11-09-2025/scorm-step1.ichyps.png)
-   Step 2: Click on the `SCORM` course item. This will add a SCORM item in side your section.
    ![scorm-step2](https://67d6ad5ef66ee0901532fd2f.storage.fermion.app/public-uncached/object-store-public-files/uploads/11-09-2025/scorm-step2.wuqkey.png)
-   Step 3: Click on the three dots of the new SCORM Item which is added as `SCORM:SCORM file`. Click on edit.
    ![scorm-step3](https://67d6ad5ef66ee0901532fd2f.storage.fermion.app/public-uncached/object-store-public-files/uploads/11-09-2025/scorm-step3.qmmgpz.png)
-   Step 4: Click on the `Drop your SCORM ZIP here to upload` button to upload a SCORM Compiant ZIP file.
    ![scorm-step4](https://67d6ad5ef66ee0901532fd2f.storage.fermion.app/public-uncached/object-store-public-files/uploads/11-09-2025/scorm-step4.rkbjox.png)
-   Step 5: Wait for the SCORM file to be processed and ready
    ![scorm-step5](https://67d6ad5ef66ee0901532fd2f.storage.fermion.app/public-uncached/object-store-public-files/uploads/11-09-2025/scorm-step5.gnaotd.png)
-   Step 6:Click on `Go back to all items` button and then click on `Publish` next to the SCORM course item.
    ![scorm-step6](https://67d6ad5ef66ee0901532fd2f.storage.fermion.app/public-uncached/object-store-public-files/uploads/11-09-2025/scorm-step6-part1.kjsazh.png)
    ![scorm-step6-part2](https://67d6ad5ef66ee0901532fd2f.storage.fermion.app/public-uncached/object-store-public-files/uploads/11-09-2025/scorm-step6-part2.prloyr.png)
