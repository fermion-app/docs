...
For detailed information about the affiliate payout dashboard, including how to request payouts and manage bank account details, see [Affiliate Payout Dashboard](/marketing-tools/affiliate-payout-dashboard).
...
- All affiliates would be able to add their payment information to receive payouts, from inside their user affiliate dashboard. For step-by-step instructions on using the payout dashboard, see [Affiliate Payout Dashboard](/marketing-tools/affiliate-payout-dashboard).
